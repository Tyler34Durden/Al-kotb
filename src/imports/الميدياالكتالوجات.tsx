import svgPaths from "./svg-a46gpl0szp";
...
import imgImageWithFallback2 from "figma:asset/2f3c462fba2a830e4742a5fb587958214aeb9204.png";
import imgImageWithFallback3 from "figma:asset/d212738ff2f0ca80dfcb4bc71d0b69853761e3eb.png";
import imgImageWithFallback4 from "figma:asset/f49a4b746876eff453fb181105b2b495ac8cc97b.png";
...
function Container() {
  return (
    <div className="absolute h-[80px] left-0 top-0 w-[1202.4px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#fe9a00] border-[0px_0px_1.6px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[47.962px]" data-name="Button">
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold leading-[28px] left-[48px] not-italic text-[#fe9a00] text-[16px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        الميديا
      </p>
    </div>
  );
...
function Button3() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] h-[31px] left-0 top-0 w-[47.962px]" data-name="Button">
...
function Container1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[47.962px]" data-name="Container">
      <Button2 />
      <Button3 />
    </div>
  );
...
function Button6() {
  return (
    <div className="h-[28px] relative rounded-[2.68435e+07px] shrink-0 w-[46.788px]" data-name="Button">
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold leading-[28px] left-[47px] not-italic text-[#303030] text-[16px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        الحلول
      </p>
    </div>
...
function Container4() {
  return (
    <div className="absolute h-[288px] left-0 opacity-20 top-0 w-[1203px]" data-name="Container">
...
function Heading1() {
  return (
    <div className="absolute h-[48px] left-[201.2px] top-[64px] w-[896px]" data-name="Heading 1">
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold leading-[48px] left-[896.95px] not-italic text-[48px] text-nowrap text-right text-white top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        الميديا
      </p>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[28px] left-[201.2px] top-[128px] w-[896px]" data-name="Paragraph">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[896.6px] not-italic text-[20px] text-blue-100 text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Input() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] h-[36px] left-0 rounded-[6px] top-0 w-[448px]" data-name="Input">
      <div className="box-border content-stretch flex h-[36px] items-center overflow-clip pl-[12px] pr-[48px] py-[4px] relative rounded-[inherit] w-[448px]">
        <p className="font-['Cairo:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#bedbff] text-[14px] text-nowrap whitespace-pre" dir="auto">
          البحث في الموارد...
        </p>
      </div>
...
function Icon() {
  return (
    <div className="absolute left-[416px] size-[20px] top-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M17.5 17.5L13.8834 13.8834" id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function Container5() {
  return (
    <div className="absolute h-[36px] left-[649.2px] top-[188px] w-[448px]" data-name="Container">
      <Input />
      <Icon />
    </div>
  );
...
function Section() {
  return (
    <div className="absolute bg-gradient-to-b from-[#13499d] h-[288px] left-0 to-[#0f1629] top-0 w-[1202.4px]" data-name="Section">
      <Container4 />
      <Heading1 />
      <Paragraph />
      <Container5 />
...
function PrimitiveButton() {
  return (
    <div className="bg-[#13499d] box-border content-stretch flex gap-[6px] h-[29px] items-center justify-center px-[8.8px] py-[4.8px] relative rounded-[12px] shrink-0 w-[197.2px]" data-name="Primitive.button">
      ...
      <p className="font-['Cairo:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#f6f6f6] text-[14px] text-nowrap whitespace-pre" dir="auto">
        الكتالوجات
      </p>
    </div>
  );
...
function PrimitiveButton1() {
  return (
    <div className="box-border content-stretch flex gap-[6px] h-[29px] items-center justify-center px-[8.8px] py-[4.8px] relative rounded-[12px] shrink-0 w-[197.2px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Cairo:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre" dir="auto">
        الأدلة
      </p>
    </div>
  );
...
function TabList() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Tab List">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex items-center justify-between px-[3px] py-[4px] relative w-full">
          <PrimitiveButton />
          <PrimitiveButton1 />
          <PrimitiveButton2 />
          <PrimitiveButton3 />
...
function CardTitle() {
  return (
    <div className="absolute h-[22px] left-[24px] overflow-clip top-[24.2px] w-[260px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[16px] left-[260.57px] not-italic text-[#0f1629] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[200px]" dir="auto">
        كتالوج المعدات الصناعية 2024
      </p>
    </div>
  );
}
...
function MediaPage() {
  return (
    <div className="absolute h-[40px] left-[24px] top-[46px] w-[259.725px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[259.91px] not-italic text-[#4a5565] text-[14px] text-right top-[-0.2px] translate-x-[-100%] w-[254px]" dir="auto">
        دليل شامل لجميع الرافعات الشوكية ومعدات المناولة
      </p>
    </div>
  );
}
...
function CardHeader() {
  return (
    <div className="absolute h-[86px] left-[0.8px] top-[216.8px] w-[307.725px]" data-name="CardHeader">
      <CardTitle />
      <MediaPage />
    </div>
  );
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[23.525px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[23.525px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[24px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">124</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[55.212px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[55.212px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[56px] not-italic text-[#4a5565] text-[14px] text-right top-[-0.2px] translate-x-[-100%] w-[56px]" dir="auto">
          الصفحات:
        </p>
      </div>
    </div>
...
function Text2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[75.525px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[75.525px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[76px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
          عربي/إنجليزي
        </p>
      </div>
    </div>
...
function Text3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[31.988px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[31.988px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[32px] not-italic text-[#4a5565] text-[14px] text-right top-[-0.2px] translate-x-[-100%] w-[32px]" dir="auto">
          اللغة:
        </p>
      </div>
    </div>
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[39.15px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[39.15px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[40px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">15 MB</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[36.813px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[36.813px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[37px] not-italic text-[#4a5565] text-[14px] text-right top-[-0.2px] translate-x-[-100%] w-[37px]" dir="auto">
          الحجم:
        </p>
      </div>
    </div>
...
function MediaPage1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[76px] items-start relative shrink-0 w-full" data-name="MediaPage">
      <Container6 />
      <Container7 />
      <Container8 />
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p1658d2c0} id="Vector" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p28db2b80} id="Vector_2" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button9() {
  return (
    <div className="bg-white h-[32px] relative rounded-[6px] shrink-0 w-[37.6px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#0f1629] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Icon2() {
  return (
    <div className="absolute left-[61.45px] size-[16px] top-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M7.99999 10V2" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
  ...
  return (
    <div className="basis-0 bg-[#13499d] grow h-[32px] min-h-px min-w-px relative rounded-[6px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-full">
        <Icon2 />
        <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[20px] left-[83.45px] not-italic text-[14px] text-nowrap text-white top-[5.8px] whitespace-pre" dir="auto">
          تحميل مجاني
        </p>
      </div>
    </div>
...
function MediaPage2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[32px] items-start justify-end relative shrink-0 w-full" data-name="MediaPage">
      <Button9 />
      <Button10 />
    </div>
  );
...
function CardContent3() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[16px] h-[148px] items-start left-[0.8px] px-[24px] py-0 top-[326.8px] w-[307.725px]" data-name="CardContent3">
      <MediaPage1 />
      <MediaPage2 />
    </div>
  );
...
function Badge2() {
  return (
    <div className="absolute bg-white h-[21.587px] left-[197.74px] rounded-[6px] top-[18.8px] w-[93.987px]" data-name="Badge2">
      <div className="h-[21.587px] overflow-clip relative rounded-[inherit] w-[93.987px]">
        <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[16px] left-[85.8px] not-italic text-[#0f1629] text-[12px] text-nowrap text-right top-[1.8px] translate-x-[-100%] whitespace-pre" dir="auto">
          معدات المناولة
        </p>
      </div>
...
function Text6() {
  return (
    <div className="h-[20px] relative shrink-0 w-[69.987px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[69.987px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[70px] not-italic text-[14px] text-right text-white top-[-0.2px] translate-x-[-100%] w-[70px]" dir="auto">
          1250 تحميل
        </p>
      </div>
    </div>
...
function Container10() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[20px] items-center justify-end left-[16px] top-[156px] w-[93.987px]" data-name="Container">
      <Text6 />
      <Icon3 />
    </div>
  );
...
function MediaPage3() {
  return (
    <div className="absolute h-[192px] left-[0.8px] overflow-clip rounded-tl-[12px] rounded-tr-[12px] top-[0.8px] w-[307.725px]" data-name="MediaPage">
      <ImageWithFallback2 />
      <Container9 />
      <Badge2 />
      <Container10 />
...
function Card3() {
  return (
    <div className="absolute bg-white h-[475.6px] left-0 rounded-[12px] top-0 w-[309.325px]" data-name="Card3">
...
function CardTitle1() {
  return (
    <div className="absolute h-[20px] left-[23.68px] overflow-clip top-[24.2px] w-[260px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal h-[16px] leading-[16px] left-[260.68px] not-italic text-[#0f1629] text-[16px] text-right top-[0.2px] translate-x-[-100%] w-[187px]" dir="auto">
        دليل أنظمة التخزين المتقدمة
      </p>
    </div>
  );
}
...
function MediaPage4() {
  return (
    <div className="absolute h-[20px] left-[23.68px] top-[49.2px] w-[259.738px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[259.99px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        حلول التخزين والرفوف للمستودعات والمصانع
      </p>
    </div>
  );
}
...
function CardHeader1() {
  return (
    <div className="absolute h-[66px] left-[0.8px] top-[216.8px] w-[307.738px]" data-name="CardHeader">
      <CardTitle1 />
      <MediaPage4 />
    </div>
  );
...
function Text7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[15.688px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[15.688px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">89</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[39.15px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[39.15px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[40px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">12 MB</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.pb43a980} id="Vector" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p28db2b80} id="Vector_2" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
...
function MediaPage6() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="MediaPage">
      <div className="flex flex-row justify-end size-full">
        <div className="content-stretch flex gap-[8px] h-[32px] items-start justify-end relative w-full">
          <Button11 />
          <Button12 />
        </div>
      </div>
...
function CardContent4() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[16px] h-[148px] items-start left-[0.8px] px-[24px] py-0 top-[327.3px] w-[307.738px]" data-name="CardContent3">
      <MediaPage5 />
      <MediaPage6 />
    </div>
  );
...
function Badge3() {
  return (
    <div className="absolute bg-white h-[21.587px] left-[206.57px] rounded-[6px] top-[18.8px] w-[85.162px]" data-name="Badge2">
      <div className="h-[21.587px] overflow-clip relative rounded-[inherit] w-[85.162px]">
        <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[16px] left-[76.8px] not-italic text-[#0f1629] text-[12px] text-nowrap text-right top-[1.8px] translate-x-[-100%] whitespace-pre" dir="auto">
          أنظمة التخزين
        </p>
      </div>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Text13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[62.15px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[62.15px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[63px] not-italic text-[14px] text-right text-white top-[-0.2px] translate-x-[-100%] w-[63px]" dir="auto">
          890 تحميل
        </p>
      </div>
    </div>
...
function Container15() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[20px] items-center justify-end left-[16px] top-[156px] w-[86.15px]" data-name="Container">
      <Text13 />
      <Icon6 />
    </div>
  );
...
function MediaPage7() {
  return (
    <div className="absolute h-[192px] left-[0.8px] overflow-clip top-[0.8px] w-[307.738px]" data-name="MediaPage">
      <ImageWithFallback3 />
      <Container14 />
      <Badge3 />
      <Container15 />
...
function Card4() {
  return (
    <div className="absolute bg-white h-[475.6px] left-[341.32px] rounded-[12px] top-0 w-[309.337px]" data-name="Card3">
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px]" />
      <CardHeader1 />
      <CardContent4 />
      <MediaPage7 />
...
function CardTitle2() {
  return (
    <div className="absolute h-[22px] left-[24.34px] overflow-clip top-[24.2px] w-[259px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[16px] left-[259.91px] not-italic text-[#0f1629] text-[16px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        كتالوج قطع الغيار الأصلية
      </p>
    </div>
  );
}
...
function MediaPage8() {
  return (
    <div className="absolute h-[40px] left-[24px] top-[46px] w-[259.725px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[259.82px] not-italic text-[#4a5565] text-[14px] text-right top-[-0.2px] translate-x-[-100%] w-[222px]" dir="auto">
        دليل قطع الغيار لجميع العلامات التجارية المتوفرة
      </p>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="h-[20px] relative shrink-0 w-[23.525px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[23.525px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[24px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">156</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[39.15px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[39.15px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[40px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">18 MB</p>
      </div>
    </div>
  );
}
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p26b72c80} id="Vector" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p28db2b80} id="Vector_2" stroke="var(--stroke-0, #0F1629)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
...
function Badge4() {
  return (
    <div className="absolute bg-white h-[21.587px] left-[222.53px] rounded-[6px] top-[18.8px] w-[69.2px]" data-name="Badge2">
      <div className="h-[21.587px] overflow-clip relative rounded-[inherit] w-[69.2px]">
        <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[16px] left-[60.8px] not-italic text-[#0f1629] text-[12px] text-nowrap text-right top-[1.8px] translate-x-[-100%] whitespace-pre" dir="auto">
          قطع الغيار
        </p>
      </div>
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function MediaPage11() {
  return (
    <div className="absolute h-[192px] left-[0.8px] overflow-clip top-[0.8px] w-[307.725px]" data-name="MediaPage">
      <ImageWithFallback4 />
      <Container19 />
      <Badge4 />
      <Container20 />
...
function Card5() {
  return (
    <div className="absolute bg-white h-[475.6px] left-[682.66px] rounded-[12px] top-0 w-[309.325px]" data-name="Card3">
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px]" />
      <CardHeader2 />
      <CardContent5 />
      <MediaPage11 />
...
function MediaPage12() {
  return (
    <div className="h-[475.6px] relative shrink-0 w-[992px]" data-name="MediaPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[475.6px] relative w-[992px]">
        <Card3 />
        <Card4 />
        <Card5 />
      </div>
...
function PrimitiveDiv() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] h-[551.6px] items-center left-[105.2px] top-[346px] w-[992px]" data-name="Primitive.div">
      <TabList />
      <MediaPage12 />
    </div>
  );
...
function MediaPage13() {
  return (
    <div className="bg-[#f6f6f6] h-[985px] relative shrink-0 w-full" data-name="MediaPage">
      <Section />
      <PrimitiveDiv />
    </div>
  );
...
function App2() {
  return (
    <div className="content-stretch flex flex-col h-[1710px] items-start overflow-clip relative shrink-0 w-full" data-name="App2">
      <Header />
      <MediaPage13 />
      <Footer25 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="الميديا - الكتالوجات">
      <App2 />
    </div>
  );
}