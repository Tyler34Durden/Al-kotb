...
import { Truck, CheckCircle2, Package, Warehouse, BarChart3, Users, ArrowRight } from 'lucide-react';
...
export function LogisticsPage({ onBack }: LogisticsPageProps = {}) {
  ...
  const challenges = [
    {
      title: 'إدارة المخزون',
      description: 'صعوبة تتبع وإدارة المخزون في مستودعات متعددة'
    },
    {
      title: 'سرعة التسليم',
      description: 'الحاجة لتقليل أوقات المعالجة والشحن لتلبية توقعات العملاء'
    },
    {
      title: 'التكاليف التشغيلية',
      description: 'السعي لتحسين الكفاءة وتقليل تكاليف التشغيل'
    }
  ];
  ...
  const solutions = [
    {
      icon: Warehouse,
      title: 'أنظمة تخزين ذكية',
      description: 'حلول رفوف وأنظمة تخزين تزيد من كفاءة استغلال المساحة'
    },
    {
      icon: Truck,
      title: 'معدات مناولة متطورة',
      description: 'رافعات شوكية وناقلات بضائع عالية الأداء'
    },
    {
      icon: BarChart3,
      title: 'حلول تحسين العمليات',
      description: 'استشارات لتحسين سير العمل وزيادة الإنتاجية'
    },
    {
      icon: Users,
      title: 'تدريب الكوادر',
      description: 'برامج تدريبية للعاملين على تشغيل المعدات بأمان'
    }
  ];

  const products = [
    {
      name: 'رافعات شوكية ديزل',
      specs: 'حمولة 3-10 أطنان، مناسبة للعمل الشاق',
      image: '/placeholder-forklift.jpg'
    },
    {
      name: 'أنظمة الرفوف المعدنية',
      specs: 'قابلة للتوسع، تحمل حتى 500 كجم لكل رف',
      image: '/placeholder-racking.jpg'
    },
    {
      name: 'ناقلات البليت',
      specs: 'يدوية وكهربائية، سعات متنوعة',
      image: '/placeholder-pallet.jpg'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50" dir="rtl">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="bg-amber-500 text-gray-900 px-4 py-2 rounded-lg">قطاع اللوجستيات</span>
            </div>
            <h1 className="mb-6">
              الشحن واللوجستيات
            </h1>
            <p className="text-xl text-blue-50 leading-relaxed">
              معدات وحلول متكاملة لتحسين عمليات الشحن والتخزين واللوجستيات، مع التركيز على الكفاءة والسرعة.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            <h2 className="mb-4">التحديات في قطاع اللوجستيات</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              نتفهم التحديات اليومية التي تواجه شركات الشحن واللوجستيات
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              مجموعة شاملة من الحلول لتحسين عمليات اللوجستيات
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              معدات عالية الجودة من أفضل الشركات المصنعة
            </p>
          </motion.div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-blue-50">
                دعنا نساعدك في تحسين عمليات اللوجستيات لديك
              </p>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="أخبرنا عن احتياجاتك من المعدات والحلول..."
                        required
                      />
                    </div>
