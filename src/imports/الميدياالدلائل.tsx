import svgPaths from "./svg-akdnnsmtpu";
...
function Badge2() {
  return (
    <div className="bg-[#f6f6f6] h-[21.587px] relative rounded-[6px] shrink-0 w-[95.737px]" data-name="Badge2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[4px] h-[21.587px] items-center justify-center overflow-clip px-[8.8px] py-[2.8px] relative rounded-[inherit] w-[95.737px]">
        <p className="font-['Cairo:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#303030] text-[12px] text-nowrap text-right whitespace-pre" dir="auto">
          تشغيل المعدات
        </p>
      </div>
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M10 5.83333V17.5" id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p25713000} id="Vector_2" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container6() {
  return (
    <div className="bg-[#f6f6f6] relative rounded-[2.68435e+07px] shrink-0 size-[40px]" data-name="Container">
...
function MediaPage() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-center justify-end left-[24px] top-[24px] w-[265.062px]" data-name="MediaPage">
      <Badge2 />
      <Container6 />
    </div>
  );
...
function CardTitle() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[82px] w-[265.062px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[265.49px] not-italic text-[#0f1629] text-[18px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        دليل تشغيل الرافعات الشوكية
      </p>
    </div>
  );
}
...
function MediaPage1() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[116px] w-[265.062px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[265.36px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        تعليمات التشغيل الآمن والصيانة الأساسية
      </p>
    </div>
  );
}
...
function CardHeader() {
  return (
    <div className="h-[136px] relative shrink-0 w-[313.062px]" data-name="CardHeader">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[136px] relative w-[313.062px]">
        <MediaPage />
        <CardTitle />
        <MediaPage1 />
      </div>
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[15.688px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[15.688px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">45</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[28.613px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[28.613px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[29px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
          عربي
        </p>
      </div>
    </div>
...
function Icon2() {
  return (
    <div className="absolute left-[89.2px] size-[16px] top-[8px]" data-name="Icon">
...
function Button9() {
  return (
    <div className="bg-[#13499d] h-[32px] relative rounded-[6px] shrink-0 w-full" data-name="Button">
      <Icon2 />
      <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[20px] left-[111.2px] not-italic text-[14px] text-nowrap text-white top-[5.8px] whitespace-pre" dir="auto">
        تحميل الدليل
      </p>
    </div>
  );
...
function CardContent3() {
  return (
    <div className="h-[148px] relative shrink-0 w-[313.062px]" data-name="CardContent3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[16px] h-[148px] items-start px-[24px] py-0 relative w-[313.062px]">
        <MediaPage2 />
        <Button9 />
      </div>
    </div>
...
function Card3() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[24px] h-[309.6px] items-start left-0 p-[0.8px] rounded-[12px] top-0 w-[314.663px]" data-name="Card3">
...
function Badge3() {
  return (
    <div className="bg-[#f6f6f6] h-[21.587px] relative rounded-[6px] shrink-0 w-[52.188px]" data-name="Badge2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[4px] h-[21.587px] items-center justify-center overflow-clip px-[8.8px] py-[2.8px] relative rounded-[inherit] w-[52.188px]">
        <p className="font-['Cairo:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#303030] text-[12px] text-nowrap text-right whitespace-pre" dir="auto">
          الصيانة
        </p>
      </div>
...
function CardTitle1() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[82px] w-[265.062px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[266.05px] not-italic text-[#0f1629] text-[18px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function MediaPage4() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[116px] w-[265.062px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[266.04px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        جداول الصيانة والفحوصات المطلوبة
      </p>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[15.688px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[15.688px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">67</p>
      </div>
    </div>
  );
}
...
function Card4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[24px] h-[309.6px] items-start left-[338.66px] p-[0.8px] rounded-[12px] top-0 w-[314.663px]" data-name="Card3">
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px]" />
      <CardHeader1 />
      <CardContent4 />
    </div>
...
function Badge4() {
  return (
    <div className="bg-[#f6f6f6] h-[21.587px] relative rounded-[6px] shrink-0 w-[57.625px]" data-name="Badge2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[4px] h-[21.587px] items-center justify-center overflow-clip px-[8.8px] py-[2.8px] relative rounded-[inherit] w-[57.625px]">
        <p className="font-['Cairo:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#303030] text-[12px] text-nowrap text-right whitespace-pre" dir="auto">
          السلامة
        </p>
      </div>
...
function MediaPage6() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-center justify-end left-[24px] top-[24px] w-[265.075px]" data-name="MediaPage">
      <Badge4 />
      <Container12 />
    </div>
  );
...
function CardTitle2() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[82px] w-[265.075px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[265.51px] not-italic text-[#0f1629] text-[18px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function MediaPage7() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[116px] w-[265.075px]" data-name="MediaPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[265.98px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        إرشادات السلامة في بيئة العمل
      </p>
    </div>
  );
}
...
function CardHeader2() {
  return (
    <div className="h-[136px] relative shrink-0 w-[313.075px]" data-name="CardHeader">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[136px] relative w-[313.075px]">
        <MediaPage6 />
        <CardTitle2 />
        <MediaPage7 />
      </div>
...
function Text8() {
  return (
    <div className="h-[20px] relative shrink-0 w-[15.688px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[15.688px]">
        <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#4a5565] text-[14px] text-nowrap text-right top-[-0.2px] translate-x-[-100%] whitespace-pre">38</p>
      </div>
    </div>
  );
}
...
function MediaPage8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="MediaPage">
      <Container13 />
      <Container14 />
    </div>
  );
...
function Icon6() {
  return (
    <div className="absolute left-[89.21px] size-[16px] top-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M8 10V2" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p23ad1400} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function Button11() {
  return (
    <div className="bg-[#13499d] h-[32px] relative rounded-[6px] shrink-0 w-full" data-name="Button">
      <Icon6 />
      <p className="absolute font-['Cairo:Medium',sans-serif] font-medium leading-[20px] left-[111.21px] not-italic text-[14px] text-nowrap text-white top-[5.8px] whitespace-pre" dir="auto">
        تحميل الدليل
      </p>
    </div>
  );
...
function CardContent5() {
  return (
    <div className="h-[148px] relative shrink-0 w-[313.075px]" data-name="CardContent3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[41px] h-[148px] items-center px-[24px] py-0 relative w-[313.075px]">
        <MediaPage8 />
        <Button11 />
      </div>
    </div>
...
function Card5() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[24px] h-[309.6px] items-start left-[677.33px] p-[0.8px] rounded-[12px] top-0 w-[314.675px]" data-name="Card3">
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px]" />
      <CardHeader2 />
      <CardContent5 />
    </div>
...
function MediaPage9() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[992px]" data-name="MediaPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-full relative w-[992px]">
        <Card3 />
        <Card4 />
        <Card5 />
      </div>
...
function PrimitiveDiv() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] h-[385.6px] items-start left-1/2 top-[calc(50%+124.3px)] translate-x-[-50%] translate-y-[-50%] w-[992px]" data-name="Primitive.div">
      <TabList />
      <MediaPage9 />
    </div>
  );
...
function MediaPage10() {
  return (
    <div className="bg-[#f6f6f6] h-[835px] relative shrink-0 w-full" data-name="MediaPage">
      <Section />
      <PrimitiveDiv />
    </div>
  );
...
function App2() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="App2">
      <Header />
      <MediaPage10 />
      <Footer25 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="الميديا - الدلائل">
      <App2 />
    </div>
  );
}