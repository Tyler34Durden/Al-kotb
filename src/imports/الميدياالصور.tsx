import svgPaths from "./svg-g1mfpd0e79";
...
import imgCard9 from "figma:asset/9459da926c86f9f155294c02612aeecc7440f34f.png";
import imgCard10 from "figma:asset/63ac936fd1d01470c45ffc681cd132210677dd20.png";
import imgCard11 from "figma:asset/e5122ed88881f7f4af6103927d3ce53c95a43f99.png";
...
function Card3() {
  return (
    <div className="[grid-area:1_/_1] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard3} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card4() {
  return (
    <div className="[grid-area:1_/_2] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard4} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card5() {
  return (
    <div className="[grid-area:1_/_3] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard5} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card6() {
  return (
    <div className="[grid-area:2_/_1] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard6} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card7() {
  return (
    <div className="[grid-area:2_/_2] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard7} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card8() {
  return (
    <div className="[grid-area:2_/_3] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard8} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card9() {
  return (
    <div className="[grid-area:3_/_1] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard9} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card10() {
  return (
    <div className="[grid-area:3_/_2] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard10} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function Card11() {
  return (
    <div className="[grid-area:3_/_3] pointer-events-none relative shrink-0" data-name="Card3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgCard11} />
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0" />
    </div>
  );
}
...
function MediaPage() {
  return (
    <div className="h-[873px] relative shrink-0 w-full" data-name="MediaPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border gap-[12px] grid grid-cols-[repeat(3,_minmax(0px,_1fr))] grid-rows-[repeat(3,_minmax(0px,_1fr))] h-[873px] relative w-full">
        <Card3 />
        <Card4 />
        <Card5 />
        <Card6 />
...
function MediaPage1() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex flex-col gap-[61px] h-[1380px] items-center relative shrink-0 w-full" data-name="MediaPage">
      <Section />
      <PrimitiveDiv />
    </div>
  );
...
function App2() {
  return (
    <div className="content-stretch flex flex-col h-[2105px] items-start overflow-clip relative shrink-0 w-full" data-name="App2">
      <Header />
      <MediaPage1 />
      <Footer25 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="الميديا - الصور">
      <App2 />
    </div>
  );
}