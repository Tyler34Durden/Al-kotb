import svgPaths from "./svg-81htcker04";
...
function Button() {
  return (
    <button className="absolute bg-[rgba(255,255,255,0.9)] box-border content-stretch cursor-pointer flex gap-[8px] items-center justify-center left-[16px] overflow-visible p-0 rounded-[6px] size-[36px] top-[16px]" data-name="Button">
      <p className="font-['Cairo:Medium','Noto_Sans_Symbols2:Regular',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">✕</p>
    </button>
  );
}
