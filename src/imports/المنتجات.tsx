import svgPaths from "./svg-n0ansx32n6";
...
function Button6() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[62.2px]" data-name="Button">
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold leading-[28px] left-[63px] not-italic text-[#fe9a00] text-[16px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        المنتجات
      </p>
    </div>
  );
...
function Button7() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] h-[31px] left-0 top-0 w-[62.2px]" data-name="Button">
...
function Container1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[62.2px]" data-name="Container">
      <Button6 />
      <Button7 />
    </div>
  );
...
function Heading1() {
  return (
    <div className="absolute h-[48px] left-[201.2px] top-[64px] w-[896px]" data-name="Heading 1">
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold leading-[48px] left-[896.4px] not-italic text-[48px] text-nowrap text-right text-white top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        منتجاتنا
      </p>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[28px] left-[201.2px] top-[128px] w-[896px]" data-name="Paragraph">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[896.7px] not-italic text-[20px] text-blue-100 text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
  ...
  return (
    <div className="absolute left-[416px] size-[20px] top-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M17.5 17.5L13.8834 13.8833" id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function CardTitle() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[24px] w-[259.725px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[259.76px] not-italic text-[#303030] text-[20px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        معدات المناولة
      </p>
    </div>
  );
...
function ProductsPage() {
  return (
    <div className="absolute h-[48px] left-[24px] top-[58px] w-[259.725px]" data-name="ProductsPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[24px] left-[260.3px] not-italic text-[#4a5565] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[256px]" dir="auto">
        رافعات شوكية، معدات السحب، ونقالات البضائع
      </p>
    </div>
  );
}
...
function CardHeader() {
  return (
    <div className="absolute h-[106px] left-[0.8px] top-[216.8px] w-[307.725px]" data-name="CardHeader">
      <CardTitle />
      <ProductsPage />
    </div>
  );
...
function ImageWithFallback2() {
  return (
    <div className="absolute h-[192px] left-[0.33px] top-[0.2px] w-[307px]" data-name="ImageWithFallback2">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p67fd620} id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M15 18H9" id="Vector_2" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p2beec100} id="Vector_3" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p13934880} id="Vector_4" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1ff3c700} id="Vector_5" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container7() {
  return (
    <div className="absolute bg-[#f6f6f6] box-border content-stretch flex items-center justify-center left-[243.72px] p-px rounded-[2.68435e+07px] size-[48px] top-[16px]" data-name="Container">
...
function ProductsPage1() {
  return (
    <div className="absolute h-[192px] left-[0.8px] overflow-clip top-[0.8px] w-[307.725px]" data-name="ProductsPage">
      <ImageWithFallback2 />
      <Container6 />
      <Container7 />
    </div>
...
function Card3() {
  return (
    <div className="absolute bg-white h-[360px] left-[683px] rounded-[12px] top-0 w-[309px]" data-name="Card3">
      <div className="h-[360px] overflow-clip relative rounded-[inherit] w-[309px]">
        <CardHeader />
        <ProductsPage1 />
      </div>
...
function CardTitle1() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[24px] w-[259.738px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[260.38px] not-italic text-[#303030] text-[20px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        معدات الورش والمصانع
      </p>
    </div>
  );
}
...
function ProductsPage2() {
  return (
    <div className="absolute h-[48px] left-[24px] top-[58px] w-[259.738px]" data-name="ProductsPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[24px] left-[260.07px] not-italic text-[#4a5565] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[259px]" dir="auto">
        أدوات كهربائية ويدوية، ضواغط، ورافعات هيدروليكية
      </p>
    </div>
  );
}
...
function CardHeader1() {
  return (
    <div className="absolute h-[106px] left-[0.8px] top-[216.8px] w-[307.738px]" data-name="CardHeader">
      <CardTitle1 />
      <ProductsPage2 />
    </div>
  );
...
function ImageWithFallback3() {
  return (
    <div className="absolute h-[192px] left-[-0.34px] top-[0.2px] w-[308px]" data-name="ImageWithFallback2">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p2a12b200} id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container9() {
  return (
    <div className="absolute bg-[#f6f6f6] box-border content-stretch flex items-center justify-center left-[243.74px] p-px rounded-[2.68435e+07px] size-[48px] top-[16px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#303030] border-solid inset-0 pointer-events-none rounded-[2.68435e+07px]" />
      <Icon2 />
    </div>
  );
...
function ProductsPage3() {
  return (
    <div className="absolute h-[192px] left-[0.8px] overflow-clip top-[0.8px] w-[307.738px]" data-name="ProductsPage">
      <ImageWithFallback3 />
      <Container8 />
      <Container9 />
    </div>
...
function Card4() {
  return (
    <div className="absolute bg-white h-[360px] left-[342px] rounded-[12px] top-0 w-[309px]" data-name="Card3">
      <div className="h-[360px] overflow-clip relative rounded-[inherit] w-[309px]">
        <CardHeader1 />
        <ProductsPage3 />
      </div>
...
function CardTitle2() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[24px] w-[259.725px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[260.27px] not-italic text-[#303030] text-[20px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        أنظمة التخزين والرفوف
      </p>
    </div>
  );
}
...
function ProductsPage4() {
  return (
    <div className="absolute h-[48px] left-[24px] top-[58px] w-[259.725px]" data-name="ProductsPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[24px] left-[260.4px] not-italic text-[#4a5565] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[253px]" dir="auto">
        رفوف ثابتة ومتحركة وحلول تخزين عالية الكثافة
      </p>
    </div>
  );
}
...
function ImageWithFallback4() {
  return (
    <div className="absolute h-[192px] left-[0.99px] top-[0.2px] w-[307px]" data-name="ImageWithFallback2">
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p3bfee9c0} id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12 22V12" id="Vector_2" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M3.29 7L12 12L20.71 7" id="Vector_3" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M7.5 4.27L16.5 9.42" id="Vector_4" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Card5() {
  return (
    <div className="absolute bg-white h-[360px] left-0 rounded-[12px] top-0 w-[310px]" data-name="Card3">
      <div className="h-[360px] overflow-clip relative rounded-[inherit] w-[310px]">
        <CardHeader2 />
        <ProductsPage5 />
      </div>
      <div aria-hidden="true" className="absolute border-[#d6d6d6] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function CardTitle3() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[24px] w-[259.725px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[259.93px] not-italic text-[#303030] text-[20px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        معدات خاصة
      </p>
    </div>
  );
...
function ProductsPage6() {
  return (
    <div className="absolute h-[48px] left-[24px] top-[58px] w-[259.725px]" data-name="ProductsPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[24px] left-[260.43px] not-italic text-[#4a5565] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[247px]" dir="auto">
        ورش متنقلة للشاحنات ومحطات غسيل السيارات المتنقلة
      </p>
    </div>
  );
}
...
function ImageWithFallback5() {
  return (
    <div className="absolute h-[192px] left-[0.33px] top-[0.42px] w-[307px]" data-name="ImageWithFallback2">
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.pd5bb600} id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M9 22V18H15V22" id="Vector_2" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 6H8.01" id="Vector_3" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M16 6H16.01" id="Vector_4" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12 6H12.01" id="Vector_5" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12 10H12.01" id="Vector_6" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12 14H12.01" id="Vector_7" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M16 10H16.01" id="Vector_8" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M16 14H16.01" id="Vector_9" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 10H8.01" id="Vector_10" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 14H8.01" id="Vector_11" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Card6() {
  return (
    <div className="absolute bg-white h-[360px] left-[683px] rounded-[12px] top-[417px] w-[309px]" data-name="Card3">
      <div className="h-[360px] overflow-clip relative rounded-[inherit] w-[309px]">
        <CardHeader3 />
        <ProductsPage7 />
      </div>
...
function CardTitle4() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[24px] w-[259.738px]" data-name="CardTitle">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[28px] left-[260.31px] not-italic text-[#303030] text-[20px] text-nowrap text-right top-[0.2px] translate-x-[-100%] whitespace-pre" dir="auto">
        قطع الغيار الأصلية
      </p>
    </div>
  );
...
function ProductsPage8() {
  return (
    <div className="absolute h-[48px] left-[24px] top-[58px] w-[259.738px]" data-name="ProductsPage">
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal leading-[24px] left-[259.75px] not-italic text-[#4a5565] text-[16px] text-right top-[-0.2px] translate-x-[-100%] w-[224px]" dir="auto">
        قطع غيار أصلية لجميع المعدات مع ضمان الجودة
      </p>
    </div>
  );
}
...
function ImageWithFallback6() {
  return (
    <div className="absolute h-[192px] left-[-0.34px] top-[0.42px] w-[308px]" data-name="ImageWithFallback2">
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p169dda00} id="Vector" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p3cccb600} id="Vector_2" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Card7() {
  return (
    <div className="absolute bg-white h-[360px] left-[342px] rounded-[12px] top-[417px] w-[309px]" data-name="Card3">
      <div className="h-[360px] overflow-clip relative rounded-[inherit] w-[309px]">
        <CardHeader4 />
        <ProductsPage9 />
      </div>
...
function Section1() {
  return (
    <div className="absolute h-[777px] left-[105px] top-[352px] w-[992px]" data-name="Section">
      <Card3 />
      <Card4 />
      <Card5 />
      <Card6 />
...
function ProductsPage10() {
  return (
    <div className="bg-[#f6f6f6] h-[1185px] relative shrink-0 w-full" data-name="ProductsPage">
      <Section />
      <Section1 />
    </div>
  );
...
function App2() {
  return (
    <div className="content-stretch flex flex-col h-[1910px] items-start overflow-clip relative shrink-0 w-full" data-name="App2">
      <Header />
      <ProductsPage10 />
      <Footer25 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="المنتجات">
      <App2 />
    </div>
  );
}